      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className={`font-bold text-xl transition-colors text-slate-800`}>
              Portfolio
            </span>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            {menuItems.map((item) => (
              <button
                ...
                className={`flex items-center space-x-1 px-3 py-2 rounded-lg transition-all duration-200 hover:bg-blue-50 ${
                  isScrolled ? 'text-slate-700 hover:text-blue-600' : 'text-blue-700 hover:text-blue-900'
                }`}
              >
